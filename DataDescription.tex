...
%Table \ref{return_stats} presents descriptive statistics of all these asset classes while figure \ref{index_levels} is a plot of the different index values over the considered period. All data expect for the risk free return is collected from Bloomberg.
...
%\subsection*{High-Yield Bond Index}
%\noindent High-Yield (HY) bonds are corporate bonds, which middle rating of Moody's, Fitch and S\&P, is Ba1/BB+/BB+ or below. Pre the 80's HY bonds were bonds of outstanding fallen angles. I.e former investment grade companies that had been downgraded. Today HY bonds are often used to finance strategic mergers and acquisitions or  by leveraged-buy-out firms to provide means of capital for highly leveraged companies. From 1998 to 2018 the US HY bond market expanded almost six fold\cite{Pimpco}. According to Bloomberg the current total size of the US corporate debt market is \$7.5 trillion of which 16.1\% (\$1.21 trillion) are HY bonds. Leveraged Loans represent roughly the same as high yield bonds, while the remaining 68\% are investment grade bonds\cite{Bloomberg}. We have chosen not to include leveraged loans in our analysis due to lack of historical data. We are aware that leveraged loans and HY bonds are not perfect substitutes for an investor, however we believe that they are similar enough to not affect conclusions substantially.              

%We will work with the "Bloomberg Barclays US Corporate High Yield Total Return Index (LF98TRUU:IND)", which we will refer to as the "HY index". The index is an unhedged \$ index, comprised of HY bonds denominated in \$ with a mininum size of \$150mn. The index dates back to july 1983 for monthly data and to august 1998 with daily data. Historically this index have returned 0.73\% per month with volatility of 2.37\% with corresponding historical annualised moments of 8.7\% and 8.2\%. Returns are negatively skewed with heavy very tails. The latter is likely due to a few extreme observations as the -15.9\% return in October 2008 and the +12.1\% return in April 2009.   
...
\caption{\text{Descriptive monthly return statistics (Aug. 1983 - Dec. 2018)}}
\label{return_stats}
\resizebox{\textwidth}{!}{
\begin{tabular}{c|cccccccc}
\toprule
    \textbf{\begin{tabular}[c]{@{}c@{}}  \end{tabular}}                     &   
    \textbf{\begin{tabular}[c]{@{}c@{}} S\&P    \\ 500 \end{tabular}}       &  
    \textbf{\begin{tabular}[c]{@{}c@{}} Russell \\ 1000 \end{tabular}}      & 
    \textbf{\begin{tabular}[c]{@{}c@{}} Russell \\ 2000 \end{tabular}}      & 
    \textbf{\begin{tabular}[c]{@{}c@{}} IG      \\ Index \end{tabular}}     &
    \textbf{\begin{tabular}[c]{@{}c@{}} HY      \\ Index \end{tabular}}     &
    \textbf{\begin{tabular}[c]{@{}c@{}} Comm.   \\ Index \end{tabular}}    
    \\ \midrule
       \begin{tabular}[c]{@{}c@{}}Arithmetic Avg. \\  Returns\end{tabular} &
        0.94\%                  &
        0.84\%                  &
        0.24\%                  &
        0.64\%                  &
    ...
    \\ \hline
         \begin{tabular}[c]{@{}c@{}} Standard \\ deviation (vol)    \end{tabular}      &
        4.24\%                 &
        4.27\%                 &
        5.46\%                 &
        1.59\%                 &
        ...
        4.10\%
    \\ \hline
     \begin{tabular}[c]{@{}c@{}} Annualised \\ returns                   \end{tabular}           &
        11.3\%                 &
        10.1\%                 &
        9.6\%                  &
        7.6\%                  &
        ...
        4.1\%
    \\ \hline
     \begin{tabular}[c]{@{}c@{}} Annualised \\ standard deviation      \end{tabular}          &
        14.7\%                 &
        14.8\%                 &
        18.9\%                 &
        5.5\%                  &
        ...
        14.2\%
    \\ \hline
      \begin{tabular}[c]{@{}c@{}} Annualised \\ Sharpe ratio        \end{tabular}            &
        0.53                  &
        0.45                  &
        0.32                  &
        0.75                  &
        ...
        0.04
    \\ \hline
      \begin{tabular}[c]{@{}c@{}}Skewness                    \end{tabular}            &
        -0.76                  &
        -0.80                  &
        -0.82                  &
        -0.29                  &
        ...
        -0.35
    \\ \hline
      \begin{tabular}[c]{@{}c@{}}Excess \\ Kurtosis                    \end{tabular}            &
        2.57                   &
        2.65                   &
        3.07                   &
        3.27                   &
        ...
        2.25
    \\ \hline
      \begin{tabular}[c]{@{}c@{}} P-value for \\ normality test                    \end{tabular}            &
        xx                   &
        xx                   &
        xx                   &
        xx                   &
    ...
    \\ \hline
\end{tabular}}
\caption*{\small{\textit{Source: Bloomberg, Fama-French and own calculations. Annualised risk free return over same period is 3.5\%. All returns presented above include the risk free return.}}}
\vspace{-50mm}
\end{table}
...
\vspace{-0mm}
\label{mth_returns}
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{images/mth_returns.png}
\begingroup
\vspace{-14mm}
